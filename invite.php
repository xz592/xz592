...
/*
	...
	$RCSfile: invite.php,v $
	$Revision: 1.17 $
	$Date: 2007/07/18 20:01:51 $
*/
...
if($action == 'buyinvite') {
	...
	if(!submitcheck('buysubmit')) {
		...
		if(!$amount || $amount < 0) {
			...
			showmessage('invite_buy_succeed', 'invite.php?action=availablelog');
		}
	}
	...
	if(!submitcheck('sendsubmit')) {
		...
		$threadurl = "{$boardurl}register.php?invitecode=$invitecode$fromuid";
