...
if(empty($action)) {
	...
	if(!submitcheck('ratesubmit')) {
		...
		$db->query("INSERT INTO {$tablepre}tradecomments (orderid, type, raterid, rater, ratee, rateeid, score, message, dateline) VALUES ('$orderid', '$type', '$discuz_uid', '$discuz_user', '$order[$ratee]', '$order[$rateeid]', '$score', '$message', '$timestamp')");
